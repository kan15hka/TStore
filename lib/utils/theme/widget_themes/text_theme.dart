...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(
        fontSize: 21.0, fontWeight: FontWeight.w600, color: TColors.dark),

    headlineSmall: const TextStyle().copyWith(
        fontSize: 17.0, fontWeight: FontWeight.w600, color: TColors.dark),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(
        fontSize: 21.0, fontWeight: FontWeight.w600, color: TColors.light),
    headlineSmall: const TextStyle().copyWith(
        fontSize: 17.0, fontWeight: FontWeight.w600, color: TColors.light),
    titleLarge: const TextStyle().copyWith(
